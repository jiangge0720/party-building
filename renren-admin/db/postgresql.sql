...
-- 初始数据
INSERT INTO sys_user (user_id, username, password, salt, email, mobile, status, dept_id, create_time) VALUES ('1', 'admin', '9ec9750e709431dad22365cabc5c625482e574c74adaebba7dd02f1129e4ce1d', 'YzcmCZNvbXocrsz9dm8e', 'root@renren.io', '13612345678', '1', '1', '2016-11-11 11:11:11');
...
INSERT INTO sys_menu(menu_id, parent_id, name, url, perms, type, icon, spread, order_num) VALUES (5, 47, 'SQL监控', 'http://localhost:8080/renren-admin/druid/sql.html', NULL, 1, 'layui-icon-chart', 0, 1);
...
alter sequence sys_menu_menu_id_seq restart with 52;
